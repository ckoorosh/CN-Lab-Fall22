...
در سناریو بعدی (شکل \ref{fig:scenario-2}) برای این‌که دو روتر را با کابل سریال به هم متصل کنیم ولی روتر 1941 پورت سریال ندارد، ابتدا ماژول \lr{HWIC-2T} را به آن اضافه می‌کنیم.
\begin{figure}[h!]
	\centering
